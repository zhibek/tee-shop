...
class TeeShop_Search_Model_Resource_Fulltext extends Mage_CatalogSearch_Model_Resource_Fulltext
{
    ...
    public function prepareResult($object, $queryText, $query)
    {
        ...
        if (!$query->getIsProcessed()) {
            ...
            if ($searchType == Mage_CatalogSearch_Model_Fulltext::SEARCH_TYPE_LIKE || $searchType == Mage_CatalogSearch_Model_Fulltext::SEARCH_TYPE_COMBINE
                ...
                // we changed OR -> AND to remove irrelevant Results at type "Like" search 
                if ($like) {
